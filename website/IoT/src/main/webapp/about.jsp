...
<link rel="stylesheet" href="all_component/styleabout.css" >	
</head>
<body>
  ...
  <div class="responsive-container-block inner-container">
    ...
    <div class="responsive-container-block">
      <div class="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 team-card-container">
        <div class="team-card">
          <div class="img-wrapper">
            <img class="team-img" src="all_component/img/Manali.jpeg">
          </div>
      ...
      <div class="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 team-card-container">
        <div class="team-card">
          <div class="img-wrapper">
            <img class="team1-img" width="280px" height="280px" src="all_component/img/aditya photo.png">
          </div>
          <p class="text-blk name">
            Aditya Patel
          </p>
      ...
      <div class="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 team-card-container">
        <div class="team-card">
          <div class="img-wrapper">
           <img class="team-img" src="all_component/img/Vishw.jpeg">
          </div>
          <p class="text-blk name">
            Vishw Patel
          </p>
      ...
      <div class="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 team-card-container">
        <div class="team-card">
          <div class="img-wrapper">
           <img class="team-img" src="all_component/img/Hetvi.jpeg">
          </div>
          <p class="text-blk name">
            Hetvi Dobariya
          </p>
